...
export default function HowItWorksPage() {
  return (
    <>
      <SiteHeader />
      <main>
        <section className="px-4 pt-16 pb-14 md:px-16 md:pt-24 md:pb-20"><div className="mx-auto max-w-280"><p className="font-mono text-[11px] tracking-[0.12em] text-ember-hover uppercase">Responsibility gates</p><h1 className="mt-4 max-w-3xl font-display text-[30px] leading-[1.16] font-bold text-navy md:text-[52px]">Completion is a claim. Verification is proof.</h1><p className="mt-5 max-w-2xl text-base leading-relaxed text-text-secondary md:text-lg">Contractor evidence, separate checking and—for priority findings—the client&rsquo;s acceptance are distinct decisions. None should be collapsed into “complete”.</p></div></section>
