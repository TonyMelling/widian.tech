...
- Widian shield and wordmark from approved repository assets
- Navy `#141D2B` and Ember `#E8431A`
- Archivo, IBM Plex Sans and IBM Plex Mono
- Core proposition and supporting promise
- “One Record, Unbroken” creative platform
- Existing product repository and current mock-up as discovery references

## Assets to obtain or verify
...
- Do not place unreadable full-dashboard screenshots inside device frames.
- Prefer focused crops, annotated sequences and interactive reconstructions based on implemented behaviour.
